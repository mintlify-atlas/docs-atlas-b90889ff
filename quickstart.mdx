...
<Steps>
  ...
  <Step title="Install the NuGet packages">
    ...
    <Tip>
      If your project only needs the repository pattern without the base controllers or encryption service, you can install `FoundationKit.Repository` and `FoundationKit.EntityFrameworkCore` alone and skip the umbrella package.
    </Tip>
  </Step>
  ...
  <Step title="Define your entity model">
    ...
    public class Person : BaseModel
    {
        ...
        // Override and mark [NotMapped] for any base property you don't need persisted
        [NotMapped]
  ...
  <Step title="Create a repository (service) class">
    ...
    namespace MyApp.Infrastructure.Interfaces;
    ...
    using MyApp.Infrastructure.Interfaces;
