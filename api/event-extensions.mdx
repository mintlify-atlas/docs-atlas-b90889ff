---
title: "Event Bus API: IRabbitMessageBroker, IMessageHandler, and EventExtensions"
sidebarTitle: "Event Extensions"
description: "Complete API reference for FoundationKit.Events: the AddEvents and AddSubscriber DI extensions, IRabbitMessageBroker publisher, IMessageHandler consumer interface, and message types."
---
