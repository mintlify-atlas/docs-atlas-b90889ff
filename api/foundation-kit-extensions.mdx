...
description: "IServiceCollection extension methods for registering FoundationKit features: AutoMapper, ASP.NET Core Identity, and the AES/TweetNaCl encryption service."
---
