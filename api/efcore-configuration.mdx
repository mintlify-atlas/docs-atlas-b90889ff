---
title: "EFCoreConfiguration<TEntity> — Entity Type Configuration Base"
sidebarTitle: "EF Configuration"
description: "EFCoreConfiguration is an abstract IEntityTypeConfiguration that applies the soft-delete global query filter. Override ConfigureEF to add entity-specific mappings."
---
...
<ResponseField name="PublicKey" type="string?">
  Base64-encoded TweetNaCl public key used for asymmetric encryption operations.
...
<ResponseField name="PrivateKey" type="string?">
  Base64-encoded TweetNaCl private key. Must be kept confidential. Never
...
<ResponseField name="Enconding" type="System.Text.Encoding?">
  ...
  during encryption and decryption. Defaults to `UTF-8` when not explicitly
  set.
</ResponseField>
