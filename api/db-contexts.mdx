...
description: "Abstract EF Core DbContext base classes that automatically set CreatedAt and UpdatedAt on every SaveChanges call. Choose the Identity variant for apps using ASP.NET Core Identity."
---
