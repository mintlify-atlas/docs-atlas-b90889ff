---
title: "Minimal API Handlers with IEndpointRouteHandler"
sidebarTitle: "Minimal API Handlers"
description: "Organize ASP.NET Core Minimal API routes using IEndpointRouteHandler and UseFoundationKitApiHandlers for clean, class-based endpoint registration by feature."
---
