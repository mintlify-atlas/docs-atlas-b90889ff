...
description: "Encrypt payloads with AES or TweetNaCl via IEncryptorService. A built-in middleware decrypts AES-encrypted request bodies before controllers see them."
---
