...
description: "FoundationKit ships two generic EF Core repository classes: BaseRepository for direct entity access and MapRepository for AutoMapper DTO projection."
---
